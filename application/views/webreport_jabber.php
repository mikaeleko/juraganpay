                                      ...
                                      <div class="box-form">
                                          <form class="form">
                                            ...
                                            <div class="form-regist">
                                              ...
                                              <input id="srv_jabber" class="input-jabber" type="hidden" name="srv_jabber" value=<?php echo $_SERVER['SERVER_NAME']; ?>>
                                              <br>
                                              <div class="label-form">
            ...
            var hash = sha1(usr_jabber + srv_jabber + pass_jabber + t);
                ...
                if(pass_jabber.match(regex)) {
                    ...
                    success: function(resultJabber){
                        ...
                        var path_error = "/memberarea/index.php/jabber?pesan=";
                        var param_error = rsJabber.pesan+"&command="+rsJabber.command;
                        var path_sukses = "/memberarea/index.php/jabber?preg=";
