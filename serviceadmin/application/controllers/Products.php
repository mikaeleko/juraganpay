...
class Products extends REST_Controller {
    ...
    function related_get() {
        ...
        $relatedProduct = $this->M_products->get_related($parent_id)->result();
    ...
    function detailProduct_get() {
        $product_id = $this->get('id');
        $detailProduct = $this->M_products->detail_product_by_id($product_id)->result();
    ...
    function getproductbycategory_get(){
      ...
      $list_product = $this->M_products->get_product_by_category($category_id)->result();
