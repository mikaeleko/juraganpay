                  ...
                  <div id="box-login" class="box-login2">
                      <form class="form-login">
                          ...
                          <div style="display: flex;justify-content: center;width:100%;">
                            <img src="../images/asset/default-logo-menu.png" style="width:150px; height:150px;vertical-align:middle;border-radius:50px;margin-left:10px">
                          </div>
                          <div style="display: flex;justify-content: center;width:100%;">
                              <input id="id" type="text" name="no_hp" placeholder="No Handphone" onkeyup="saveValue(this);" style="width:200px;height:30px;border:none;margin:1px;padding:5px;color:#00AFE9;font-size:16px;text-align:center;">
                          </div>
                          <div style="display: flex;justify-content: center;width:100%;">
                              <input id="pwd" type="password" name="password" placeholder="Password" onkeyup="saveValue(this);" style="width:200px;height:30px;border:none;margin:1px;padding:5px;color:#00AFE9;font-size:16px;text-align:center;">
                          </div>
                          <!--CAPTCHA INPUT -->
                          <div id="box-captcha" style="display: flex;justify-content: center;width:100%;margin-top:20px;">
                            <img id="captcha" src="<?=site_url('otentikasi/securimage')?>" alt='captcha' />
                          </div>
                          <div style="display: flex;justify-content: center;width:100%;">
                            <input id="capcode" type="text" name="captcha_code" size="15" placeholder="Input Captcha"/ style="width:150px;height:30px;border:none;margin:10px;padding:5px;color:#00AFE9;font-size:16px;text-align:center;">
                            <a href="javascript:void(0)" style="margin-top:12px;" onclick="refreshCaptcha()">
                              <img style="height:32px;width:32px;margin:0 auto;vertical-align: middle;" src="<?php echo base_url() ?>assets/image/refreshblue2.png" alt="Refresh Captcha" onclick="this.blur()" style="border:0px;vertical-align:bottom;">
                            </a>
                          </div>
                          <div style="display: flex;justify-content: center;width:100%;">
