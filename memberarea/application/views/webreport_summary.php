...
<html>
    ...
    <body>
                ...
                <div class="row">
                    ...
                    <div class="col-desk-7 col-md-4">
                        <div class="header-center">
                            <div class="box-header"><span class="box-header-title">SUMMARY TRANSAKSI</span></div>
                        </div>
                    </div>
        ...
        function cari(){
            ...
            $.ajax({
    				type: "POST",
    				url:  "<?php echo base_url(); ?>" + "summary/cari",
            ...
            contentType: "application/json;",
                ...
                for (var i = (rs.length-1); i >= 0; i--){
                  createCellTable(
                    table,
                    rs[i].STORE_ID,rs[i].USER_NAME,rs[i].FULL_NAME,rs[i].NOM,rs[i].QTY,rs[i].PRICE,rs[i].TOTAL_PRICE);
                }
                if (rs.length>0) {
        ...
        function createheaderTable(table){
          ...
          cell1.outerHTML  = "<th>Store ID</th>";
          cell2.outerHTML  = "<th>User Name</th>";
          cell3.outerHTML  = "<th>Full Name</th>";
          cell4.outerHTML  = "<th>Nom</th>";
          cell5.outerHTML  = "<th>Qty</th>";
          cell6.outerHTML  = "<th>Price</th>";
          cell7.outerHTML  = "<th>Total price</th>";

        }

        function createCellTable(table, col1,col2,col3,col4,col5,col6,col7){
          var row    = table.insertRow(0);
          var cell1  = row.insertCell(0);
          var cell2  = row.insertCell(1);
          var cell3  = row.insertCell(2);
          ...
          cell5.innerHTML  = '<div style="width:100%;text-align:right">'+col5+'</div>';
