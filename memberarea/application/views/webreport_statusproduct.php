            ...
            contentType: "application/json;",
                ...
                for (var i = 0;i<rs.length; i++){
                  ...
                  if(rs[i].TAG == "#PEMBAYARAN"){
                    ...
                    // var strArray = rs[i].FEE.split(" ");
                    // var strArray1 = parseInt(strArray[1]);
                    // console.log(strArray1);
                    // if (strArray1 > 0){
                    //   f = "<span style='font-size:14px;text-align:left;'>Admin  : " +rs[i].HARGA+ "<br> Markup : " + rs[i].FEE+ "</span>";
                    // } else if(strArray1 == 0){
                    //   f = "<span style='font-size:14px;text-align:left;'>Admin  : " +rs[i].HARGA+ "<br> Fee : - </span>";
                    // } else if(strArray1 < 0){
                    //   f ="<span style='font-size:14px;text-align:left;'>Admin  : " +rs[i].HARGA+ "<br> Fee : " + strArray[1]+ "</span>";
                    // }
