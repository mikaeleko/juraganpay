...
<html>
    ...
    <body>
                                    ...
                                    <div class="col-desk-12">
                                        <div>
                                          <!-- contoh 0856282829339 -->
                                            <input type="text" id="no_hp" value="" placeholder="No. Hp">
                                            <input type="date" id="input_start_date" value="<?php echo date('Y-m-d'); ?>" placeholder="tgl awal">
                                            <input type="date" id="input_end_date" value="<?php echo date('Y-m-d'); ?>" placeholder="tgl akhir">
                                            ...
                                            <input type="submit" onclick="cari()" value="Filter">
        ...
        function syncExportData(){
            ...
            var input_trans_stat = document.getElementById("input_trans_stat").value;
            var t = getDateTime();
            var h = sha1(input_start_date.value + input_end_date.value + input_trans_stat + '<?=$this->session->userdata('store_id')?>' + '<?=$this->session->userdata('username')?>' + t);
            $.ajax({
                type: "POST",
