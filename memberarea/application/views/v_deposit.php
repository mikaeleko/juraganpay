...
<html>
    ...
    <body>
                ...
                <div class="row">
                    ...
                    <div class="col-desk-7 col-md-4">
                        <div class="header-center">
                            <div class="box-header"><span class="box-header-title">HISTORI DEPOSIT</span></div>
                        </div>
                    </div>
        ...
        function cari(){
            ...
            $.ajax({
    				type: "POST",
    				url:  "<?php echo base_url(); ?>" + "deposit/cari",
    				data: JSON.stringify({start_date: input_start_date.value, end_date : input_end_date.value, store_id : "<?=$this->session->userdata('store_id')?>", uname : '<?=$this->session->userdata('username')?>',offset:offset,limit:limit, t:t,h:h}),
        ...
        function createheaderTable(table){
          ...
          cell5.outerHTML  = "<th>No.Hp</th>";
          cell6.outerHTML  = "<th>Jumlah</th>";
          cell7.outerHTML  = "<th>Trans Stat</th>";
          cell8.outerHTML  = "<th>Balance</th>";

        }

        function createCellTable(table, col1,col2,col3,col4,col5,col6,col7,col8,is_curent_date){
          var row    = table.insertRow(0);
          var cell1  = row.insertCell(0);
          var cell2  = row.insertCell(1);
          var cell3  = row.insertCell(2);
          ...
          if (is_curent_date.includes("HARI INI")) {
              current_date = '<span style="color:#223e92"><b>'+col3+'</b></div>';
          }else{
              current_date = '<span style="color:#7b7b7b"><b>'+col3+'</b></div>';
          }
          cell4.innerHTML  = col4;
          cell5.innerHTML  = col5;
          cell6.innerHTML  = '<div style="width:100%;text-align:right">'+col6+'</div>';
          cell7.innerHTML  = col7;
          cell8.innerHTML  = '<div style="width:100%;text-align:right">'+col8+'</div>';
