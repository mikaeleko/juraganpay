<div style="margin-top: 13px;margin-right:25px;text-align:right;">
    <span id="text-name" class="segoe"></span><br>
    <span id="text-balance" class="segoe"></span><br>
    <button class="button-topup" onclick="onClickTopup()" style="margin:0;background-color:rgb(0, 175, 233);color:white;font-weight:800;font-size:15px;">TOP UP</button>
</div>
...
<script>
    ...
    function onClickTopup(){
        ...
        window.location = base_url+"akun?show=tiketdeposit";
    }
