            ...
            <div class="header-belanja sukses">
                ...
                <div class="row">
                  ...
                  <div class="col-desk-10">
                    <div class="body-right-container">
                      <div style="font-size:18px;font-weight:bold;opacity:0.6">
                        <span>1. Pesan</span><span style="font-size:17px;font-weight:bold;opacity:1px;"> > </span><span>2. Pembayaran </span></span><span> > </span><span>3. Selesai </span>
                      </div>
                          ...
                          <div class="row ">
                            <div class="col-desk-10">
                              <div class="row">
                                <div class="col-desk-12">
                                  <div class="">
                                    <img src="<?php echo base_url() ?>/assets/img/AssetPesawat/penerbangan.png" alt="" style="width:40px;height:40px;margin:25px 0 12px 25px;justify:center;float:left;">
                                    <span style="margin:0 auto;vertical-align:middle;text-align:justify;font-family:Segoe UI;font-style:normal;font-size:18px;position:absolute;margin-top:35px;margin-left:5px;">Pilih Penerbangan</span>
                                  </div>
                                </div>
                ...
                <div id="page3" style="display:block;">
                 <div class="row">
                  ...
                  <div class="col-desk-7">
                      <div style="padding-left:40px;">
                        <span style="color:#000;font-size:18px;">Menampilkan Jumlah Penerbangan Terbaik</span>
                      </div>
                  </div>
                 ...
                 <div class="row ">
                  ...
                  <div class="col-desk-2" >
                    <div class="box-menu-tiket" style="margin-bottom:40px;">
                      <div class="main-area list-menu" >
                        <div id="transit">
                          <div class="item-category">
                            <div class="item-category">
                              <span> Transit </span>
                              <img src="<?php echo base_url() ?>/assets/img/AssetPesawat/dropdown.png" alt="" style="margin:10px;justify:center;float:right;width:12px;height:8px;">
                            </div>
                          </div>
                        </div>
                        ...
                        <div id="durasi">
                          <div class="item-category">
                            ...
                            <div id="list-durasi" style="display:none;height:70px;">
                              <div class="item-inner-category">
                                <div class="item-inner-category" >
                                    <span style="font-size:11px;text-align:left;"> Durasi Per Transit 0j - 8j </span><br><br>
                                    <div class="slidecontainer" style="padding-bottom:10px;">
                                      <input type="range" min="0" max="8" value="0" class="slider" id="myRange">
                                      <input style="width:10px;border:none;margin-top:5px;margin-left:50px;"type="text" id="input-durasi" value="0">
                                    </div>
                                </div>
                              </div>
                        ...
                        <div id="waktu" class="waktu" >
                          <div class="item-category">
                            ...
                            <div id="list-waktu" style="display:none;">
                              <div class="item-inner-category" style="height:15px;">
                                <div class="item-inner-category">
                                    <span style="font-weight:500;"> Berangkat </span>
                                </div>
                              </div>
                              <div class="item-inner-category">
                                <div class="item-inner-category">
                              ...
                              <div class="item-inner-category" style="height:15px;">
                                <div class="item-inner-category">
                                    <span style="font-weight:500;"> Tiba </span>
                                </div>
                              </div>
                              <div class="item-inner-category">
                                <div class="item-inner-category">
                        ...
                        <div id="maskapai">
                          <div class="item-category">
                            ...
                            <div id="list-maskapai" style="display:none;">
                              <div class="item-inner-category">
                                <div class="item-inner-category">
                                    <img src="<?php echo base_url() ?>/assets/img/AssetPesawat/LogoMaskapai/airasia.png" alt="">
                                    <span class="maskapai"> AirAsia </span>
                                    <div style="border:0.5px solid #707070;margin:10px;justify:center;float:right;width:10px;height:10px;background-color:#fff;cursor:pointer;"></div>
                                </div>
                              </div>
                              <div class="item-inner-category">
                                <div class="item-inner-category">
                                    ...
                                    <span class="maskapai"> AirChina </span>
                                    <div style="border:0.5px solid #707070;margin:10px;justify:center;float:right;width:10px;height:10px;background-color:#fff;cursor:pointer;"></div>
                                </div>
                              </div>
                              <div class="item-inner-category">
                                <div class="item-inner-category">
                                    <img src="<?php echo base_url() ?>/assets/img/AssetPesawat/LogoMaskapai/americanairlines.png" alt="" >
                                    <span class="maskapai"> American Airlines </span>
                                    <div style="border:0.5px solid #707070;margin:10px;justify:center;float:right;width:10px;height:10px;background-color:#fff;cursor:pointer;"></div>
                                </div>
                              </div>
                            </div>
                        ...
                        <div id="fasilitas">
                          <div class="item-category">
                            ...
                            <div id="list-fasilitas" style="display:none;">
                              <div class="item-inner-category">
                                <div class="item-inner-category">
                                    <p><span> Bagasi </span><span style="font-size:9px;float:left;margin-top:10px;">Jumlah Penerbangan</span></p>
                                    <div style="border:0.5px solid #707070;margin:10px;justify:center;float:right;width:10px;height:10px;background-color:#fff;cursor:pointer;"></div>
                                </div>
                              </div>
                              <div class="item-inner-category">
                                <div class="item-inner-category">
                                  <p><span> Hiburan </span><span style="font-size:9px;float:left;margin-top:10px;">Jumlah Penerbangan</span></p>
                                  <div style="border:0.5px solid #707070;margin:10px;justify:center;float:right;width:10px;height:10px;background-color:#fff;cursor:pointer;"></div>
                                </div>
                              </div>
                              <div class="item-inner-category">
                                <div class="item-inner-category">
                                  <p><span> Makanan </span><span style="font-size:9px;float:left;margin-top:10px;">Jumlah Penerbangan</span></p>
                                  <div style="border:0.5px solid #707070;margin:10px;justify:center;float:right;width:10px;height:10px;background-color:#fff;cursor:pointer;"></div>
                                </div>
                              </div>
                            </div>
                      ...
                      <div class="box-menu-tiket" style="margin-top:0px;margin-bottom:40px;">
                        <div class="row">
                          <div style="padding:10px;">
                            <div class="col-desk-12">
                              <span style="color:#00AFE9;">Nama Maskapai</span>
                            </div>
                          </div>
                        </div>
                        <div class="row">
                          <div class="col-desk-2">
                            <div style="width:70px;height:20px;padding:20px;">
                              <img src="<?php echo base_url() ?>/assets/img/AssetPesawat/LogoMaskapai/airasia.png" alt="" style="justify:center;width:60px;height:30px;display:block;margin:auto;vertical-align:middle;text-align:center;">
                            </div>
                          </div>
                          <div class="col-desk-4">
                            <div style="margin-top:20px;justify:center;vertical-align:middle;text-align:center;">
                              ...
                              <img src="<?php echo base_url() ?>/assets/img/AssetPesawat/line_29.png" alt="" style="justify:center;vertical-align:middle;text-align:center;">
                              <img src="<?php echo base_url() ?>/assets/img/AssetPesawat/Icon_metro-airplane.png" alt="" style="width:15px;height:15px;justify:center;vertical-align:middle;text-align:center;">
                              <span> A.Time To </span>
                            </div>
                          </div>
                          <div class="col-desk-4">
                            <div style="width:70px;height:20px;padding:20px;">
                              <img src="<?php echo base_url() ?>/assets/img/AssetPesawat/addbagasi.png" alt="" style="width:25px;height:28px;display:block;margin:auto;vertical-align:middle;text-align:left;">
                            </div>
                          </div>
                          <div class="col-desk-2">
                ...
                <div id="page4" style="display:none;">
                 <div class="row ">
                  ...
                  <div class="col-desk-6 col-md-6 col-xs-6" >
                    <div class="box-menu-tiket" style="margin:0;margin-bottom:10px;">
                      <div class="main-area list-menu" >
                        <div id="detail-pesan">
                 ...
                 <div class="row">
                  ...
                  <div class="col-desk-6 col-md-6 col-xs-6">
                    <div class="box-menu-tiket" style="margin-top:0;margin-bottom:10px;margin-top:-25px;">
                      <div class="main-area list-menu" >
                        <div id="detail-pesan">
                          <div class="item-category nobottomline">
                      ...
                      <div class="box-menu-tiket" style="margin-top:0;margin-bottom:40px;">
                        ...
                        <div class="row">
                          <div >
                            <div class="col-desk-2 col-md-2 col-xs-2">
                              <div class="">
                                <img style="width:32px;height:120px;padding-top:20px;display:block;margin:0 auto;"src="<?= base_url() ?>assets/img/assetpesawat/iconshort.png" alt="">
                              </div>
                            </div>
                            <div class="col-desk-10 col-md-10 col-xs-10">
