                        ...
                        <div class="container-belanja smooth">
                            ...
                            <div class="row" >
                                <div class="col-desk-12 col-sm-12 col-md-12">
                                  <h3 style="text-align:center;">Pembelian Paket Internet</h3>
                                </div>
                    ...
                    $.ajax({
                        ...
                        success: function(result){
                            ...
                            for(var i = 0;i < rs.length; i++){
                                ...
                                productItem +=     '<div style="background-color:'+color+';box-shadow: 1px 1px 3px #888888;" class="list-pulsa" onclick="selectionChildItem(this,'+rs[i].PRICE+',\''+rs[i].NOM+'\',\''+rs[i].DENOM+'\',\''+rs[i].DSC+'\','+i+')" id="itemChildId'+i+'" >'+
