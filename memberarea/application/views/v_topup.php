...
<html>
    ...
    <body>
                                ...
                                <div class="row">
                                  ...
                                  <div class="col-desk-12">
                                          ...
                                          <form class="form" autocomplete="off" >
                                            ...
                                            <input type="hidden" name="bmc" value="" id="bmc">
                              ...
                              <div class="col-desk-12 col-md-12 col-sm-12">
                                ...
                                <table width="100%">
                                  ...
                                  <tr>
                                    ...
                                    <td>: </td>
                                    <td><span id="total-topup" style="color:rgba(112,112,112,1);font-weight:bold;font-size:20px;margin:5px;"></span></td>
                                  </tr>
                                  <tr>
                                    <td><div class="text-title" style="color:rgba(112,112,112,1);font-weight:bold;font-size:20px;margin:5px;">Biaya</div></td>
                                    <td>: </td>
                                    <td>
                                      <span id="biaya" style="color:rgba(112,112,112,1);font-weight:bold;font-size:20px;margin:5px;"> </span>
                                      <input id="biaya2" type="hidden" name="biaya2" value="">
                                    </td>
                                  </tr>
                                  <tr>
                                    <td><div class="text-title" style="color:rgba(112,112,112,1);font-weight:bold;font-size:20px;margin:5px;">Total</div></td>
                                    <td>: </td>
                                    <td><span id="total" style="color:rgba(112,112,112,1);font-weight:bold;font-size:30px;margin:5px;"> </span></td>
                                  </tr>
                                </table>
                                <hr>
        ...
        function closeModalTiket(){
          ...
          document.getElementById("bmc").value = "";
        ...
        function angka(e) {
          ...
          if (!/^[0-9]+$/.test(e.value)) {
            ...
            var res      = biaya.split(" ");
            var totalBiaya = 0;
            var totalBiaya =  parseInt(bilangan) + parseInt(biaya2);
            console.log(res[1]);
            var ttl = totalBiaya
            ...
            var	number_string = bilangan.toString(),
                ...
                number_string2 = ttl.toString(),
                sisa_ttl 	  = number_string2.length % 3,
              	rupiah_ttl 	= number_string2.substr(0, sisa_ttl),
              	ribuan_ttl 	= number_string2.substr(sisa_ttl).match(/\d{3}/g);
            ...
            if (ribuan_ttl) {
            	separator_ttl = sisa_ttl ? '.' : '';
            	rupiah_ttl += separator_ttl + ribuan_ttl.join('.');
            }


            $("#total-topup").html("Rp "+ rupiah);
            if(rupiah_ttl == "" || rupiah_ttl == null){
              $("#total").html("Rp "+ rupiah);
            }else{
              $("#total").html("Rp "+ rupiah_ttl);
            }
          }
        }
        ...
        $(document).ready(function(){
          ...
          $("#radio-ovo, #sub-ovo").click(function(){
            ...
            document.getElementById("total-topup").innerHTML = "";
            document.getElementById("bmc").value = "EWALLET_OVOE";
            $("#total-topup").show();
          ...
          function getBiaya(){
            var t            = getDateTime();
            var mitra_code   = document.getElementById("bmc").value;
            var h            = sha1(mitra_code + t);

            $.ajax({
              type  : "POST",
              url   :  "<?php echo base_url(); ?>" + "topup/get_biaya",
              data: JSON.stringify({
              ...
              cache: false,
              success: function(data){
                var resBiaya = JSON.parse(data);

                if(resBiaya.status_code == '200'){
                  var	number_str = resBiaya.biaya.toString(),
                  ...
                  $('#biaya').html("Rp "+ rupiah);
                  $('#biaya2').val(number_str);
                }

              },
              error: function(error){
                alert('Gagal Ambil Biaya');
              }
            });
          }
          ...
          $(".icon-cvs").click(function(){
            ...
            switch(valuecvs){
              case 'ALMA':
                ...
                document.getElementById("bmc").value = "CVS_ALMA";
              break;
              case 'INDO':
          ...
          $('.virtual-account').change(function(){
              ...
              switch(va){
                case 'CENA':
                  srcText = '<?=base_url()?>'+'assets/img/bankwithborder-01.png';
                  document.getElementById("bmc").value = "VA_CENA";
                break;
                case 'BRIN':
                  srcText = '<?=base_url()?>'+'assets/img/bankwithborder-02.png';
                  document.getElementById("bmc").value = " ";
                ...
                case 'BNIN':
                  srcText = '<?=base_url()?>'+'assets/img/bankwithborder-03.png';
                  document.getElementById("bmc").value = "VA_BNIN";
                break;
                case 'BMRI':
                  srcText = '<?=base_url()?>'+'assets/img/bankwithborder-04.png';
                  document.getElementById("bmc").value = "VA_BMRI";
                break;
                case 'BDIN':
                  srcText = '<?=base_url()?>'+'assets/img/bankwithborder-05.png';
                  document.getElementById("bmc").value = "VA_BDIN";
                break;
                case 'BNIA':
                  srcText = '<?=base_url()?>'+'assets/img/bankwithborder-06.png';
                  document.getElementById("bmc").value = "VA_BNIA";
                break;
                case 'HNBN':
                  srcText = '<?=base_url()?>'+'assets/img/bankwithborder-07.png';
                  document.getElementById("bmc").value = "VA_HNBN";
                break;
                case 'BBBA':
                  srcText = '<?=base_url()?>'+'assets/img/bankwithborder-08.png';
                  document.getElementById("bmc").value = "VA_BBBA";
                break;
                case 'IBBK':
                  srcText = '<?=base_url()?>'+'assets/img/bankwithborder-09.png';
                  document.getElementById("bmc").value = "VA_IBBK";
                break;
              }
            ...
            if(nominal==''){
              ...
              $("#img_err").hide();
                ...
                if(type == "DEPOSIT"){
                  ...
                  var pm = "03";
                  var mitra = $("#code").val();
                  var biaya      = $("#biaya2").val();
                  var total_bayar   = document.getElementById("total").innerHTML;
                  console.log("Biayanya ==> ",biaya);
                  var h     = sha1(type + pm +  t);
                  var srcText = "";
                  switch(mitra){
                    case 'ALMA':
                          ...
                          $.ajax({
                              ...
                              success: function(resultTiket){
                                  ...
                                  if(resTiket.status_code == '200'){
                                    ...
                                    $("#detail-bank2").hide();
                                    $("#textcvs").show();
                                    $(".jumlah-transfer2").html(total_bayar);
