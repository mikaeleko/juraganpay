                ...
                <div class="row">
                  <div class="col-desk-12">
                    <div class="navigation-feature">
                      <button title="Pulsa" class="button-image color-white active-menu" ><img class="image-inner" src="<?php echo base_url() ?>images/asset/assetwebsite-01.png"></button>
        ...
        <script>
                    ...
                    $.ajax({
                        ...
                        success: function(result){
                                                        ...
                                                        '<tr>'+
                                                            '<td>'+
                                                                '<div class="image-item">'+
                                                                    '<img src="<?=HOST_API_IMAGE?>get_img?file='+rs[i].IMG_FILE_NAME+'" >'+
                                                                '</div>'+
                                                            '</td>'+
                                                            '<td>'+
                                                            rs[i].DENOM+
                            ...
                            if(rs.length>0){
                                ...
                                logoOperator.innerHTML = '<img class="img-operator" alt="No img" src="<?=HOST_API_IMAGE?>get_img?file='+rs[0].child[0].IMG_FILE_NAME+'">'
                            }else{
                                isExist = 0;
            ...
            function viewChild(idxSelected){
                ...
                for(var i = 0;i < rs.length; i++){
                    ...
                    productItemChild += '<div onclick="selectionChildItem(this,'+rs[i].PRICE+',\''+rs[i].NOM+'\',\''+rs[i].DENOM+'\')" id="itemChildId'+i+'" class="product-name" style="width:170px;">'+
                                                    '<table>'+
                                                        '<tr>'+
                                                            '<td>'+
                                                                '<div class="image-item">'+
