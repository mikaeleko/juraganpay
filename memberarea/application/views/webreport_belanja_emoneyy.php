                            ...
                            <div class="row">
                                <div class="col-desk-12">
                                    <div>
                                        ...
                                        <div id="list-product-parent" class="row list-product-parent" style="padding:50px;">
          ...
          function loadProduct(){
              ...
              success: function(result){
                  ...
                  for(var i = 0;i < rs.length; i++){
                      ...
                      productItem += '<div class="cold-desk-4 col-sm-4 col-md-4">' +
                  ...
                  success: function(result){
                      ...
                      for(var i = 0;i < rs.length; i++){
                        if(i % 2 == 0) {
                          ...
                          productItem +=   '<div id="itemid'+i+'" onclick="selectionItem(this,'+rs[i].PRICE+','+i+',\''+rs[i].NOM+'\',\''+rs[i].IMG_FILE_NAME+'\')" style="cursor:pointer;box-shadow: 1px 1px 3px #888888;background-color:#FFF;width:600px;height:auto;font-weight:bold;fon-size:18px;padding:5px;color:white;">'+
                                            '<table width="100%">'+
                                              '<tr>'+
                                                '<td width="1%">'+
                                                  '<div class="image-item-emoney">'+
          ...
          function selectionItem(data,price,idxSelected,kdProduk,imgName){
            ...
            function cariProduk(param){
                ...
                for(var i = 0;i < dataSearchResultsLength; i++){
                    productItemSearch += '<div onclick="selectionItem(this,'+dataSearchResults[i].PRICE+','+i+',\''+dataSearchResults[i].NOM+'\',\''+dataSearchResults[i].IMG_FILE_NAME+'\')" id="itemid'+i+'" class="product-name" style="width:170px;">'+
                                            '<table>'+
                                                '<tr>'+
                                                    '<td>'+
                                                        '<div class="image-item">'+
                                                            '<img src="<?=HOST_API_IMAGE?>get_img?file='+dataSearchResults[i].IMG_FILE_NAME+'" >'+
                                                        '</div>'+
                                                    '</td>'+
                                                    '<td>'+
