        ...
        function getdata(){
            ...
            contentType: "application/json;",
                ...
                var produk="";
                    ...
                    no = 0;
                    header +=
                       '<table width ="100%"> <tr style="background-color: rgba(0,175,233,1);color:#fff;"> <th>No.</th> <th> </th>  <th>Produk</th> <th>Harga</th> <th>Status</th> </tr>';
                for (var i = 0;i<rs.length; i++){
                  ...
                  produk +=  '<tr style="background-color:'+color+'">' +
                              '<td width="2%">'+no+'</td>'+
                              '<td width> <img style="width:40px; height:40px; display:block; margin-left:auto; margin-right:auto; padding:3px;border-radius:0 10px 0 10px;" class="img-group" src="' + rs[i].IMG+' " > </td>'+
                              '<td > <span style="font-weight:bold;font-size:16px;">'+ rs[i].SHORT_DSC + '</span>' +
                                '<br><span style="font-size:12px;">' + rs[i].KET + '</span>' +
                              '</td>'+
                              '<td>'+rs[i].HARGA+'</td>'+

                              '<td>'+rs[i].STATUS+
                              '<img style="width:20px; height:20px; display:block; padding:3px;border-radius: 0 10px 0 10px;text-align:center;vertical-align:middle;margin:0 auto;float:right;" src="<?php echo base_url(); ?>images/icon/'+imgStatus+' " >' +
                              '</td>' +
                            '</tr>' ;
