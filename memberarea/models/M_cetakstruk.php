  ...
  public function cari($data) {
    $sql = "SELECT *
     ...
     WHERE ROW_NUM >= ? AND ROW_NUM <= ?";
      ...
      $this->st24apiv1->set_query($sql,['%'.$data['sender'].'%','%'.$data['key'].'%',$data['start_date'],$data['end_date'],$data['store_id'],$data['uname'],$data['uname'],$data['uname'],$data['uname'],$data['offset'],$data['limit']]);
