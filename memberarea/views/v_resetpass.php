    ...
    <body>
        <div class="container smooth">
            <div class="header">
                ...
                <div class="to-right">
                    <div>
                        <img src="<?php echo base_url() ?>/images/logo_st24_nolabel.png">
            ...
            <div class="body-container">
                <div class="parent-box-login">
                  <div id="box-forgot" class="box-login2">
                      <form>
                          ...
                          <div class="text-title" style="width:100%;text-align:center">Renew Your Password!</div>
                          ...
                          <div style="display: flex;justify-content: center;width:100%;">
                              <input id="idforgot" type="text" name="imgname" placeholder="ID/Username">
                          </div>
                          <div style="display: flex;justify-content: center;width:100%;">
...
$(document).ready(function(){
   ...
   $("#submit-forgot").click(function(event){
     ...
     var h = sha1(idforgot + pwdnew + pwdconf + t);
 		...
 		if(idforgot=='' && pwdnew==''&& pwdconf=='')
 			{
 				$("#err_msg").show();
 				$("#msg").html("Anda Belum Memasukan Apapun!");
      }else if(idforgot==''){
        $("#err_msg").show();
 				$("#msg").html("ID/Username Belum Diisi!");
        $("#idforgot").focus();
      }else if(pwdnew==''){
        $("#err_msg").show();
        ...
        $("#pwdconf").focus();
         ...
         regexResult = pwdnew.match(regex)?1:0;
