...
<html>
    ...
    <body>
        <div class="container">
            ...
            <div id="modal" class="modal">
                <div class="modal-body">
                    ...
                    <div style="padding-left:5%;padding-right:5%" align="center">
                        <div id="loading-transaction" class="loading-ring" style="display:none"><div></div><div></div><div></div><div></div></div>
                        <table style="width:100%">
                            <tr>
                                <td>Nomor Meter/ID</td><td>:</td><td><div class="value-checkout"><input placeholder="..." onkeydown="if (event.keyCode == 13) { return false;}" style="border-width:1;border-color: #d0d0d0;border-radius: 5px;margin-right: 5px;text-align:right;padding:5px;font-size:16px;font-family:Segoe UI;cursor:pointer" title="Nomor Meter/ID" id="checkout-nohp" type="text" ><button onclick="onClickCekId()" class="button">Cek ID</button><div></td>
                            </tr>
                            <tr>
                        ...
                        <br>
                        <div class="detailIdPelanggan">
                            <div id="loading-cekid" class="loading-ring" style="display:none"><div></div><div></div><div></div><div></div></div>
                            <div style="text-align: center;">
                              <pre id="detailIdPelangganMsg" class="smooth" style="display:none;font-family:monospace;text-align:left;border:1px dotted #000;padding:10px; font-weight:bold;border-radius:30px;">TEST</pre>
                            </div>
                        </div>
            ...
            <div id="modal-print" class="modal">
                <div class="modal-body">
                    ...
                    <div align="center">
                        ...
                        <br>
                        <button onclick="printDiv()" class="button">
                        ...
                        <div class="container-belanja smooth">
                            ...
                            <div class="row">
                                ...
                                <div class="col-desk-12 col-sm-12 col-md-12">
                                  <h3 style="text-align:center;">Pengisian Token Listrik</h3>
                                </div>
                                ...
                                <div class="col-desk-12">
                                  ...
                                  <div class="col-desk-12" >
                                    <div>
                                      <center>
                                        <div class="loading-ring" id="loading" style="display:none"><div></div><div></div><div></div><div></div></div>
                                      </center>
                                    </div>
        ...
        <script>
          ...
          function onClickCekId(){

            $('#detailIdPelangganMsg').hide(100);
            tujuan = ckNoHp.value;
            if(tujuan == ""){
                ...
                $("#sukses_msg").fadeIn();
                $("#sukses_show").html("Nomor Meter/ID Pelanggan harus diisi!");
                return;
            }

            $("#sukses_msg").hide();
            loadingCekID.style.display = "block";
            var button = "";

            var text = "cek.pln" + '.' + tujuan + '.' + inputPin.value;
            ...
            $.ajax({
                ...
                success: function(result){
                    ...
                    loadingCekID.style.display = "none";
                    ...
                    if(rs.Rows[0].RC == "00"){
                        cu = "";
                        var messageid = rs.Rows[0].MESSAGE.replace(/([|])/g,'<br>');
                        document.getElementById('detailIdPelangganMsg').style.display = "inline-block";
                        document.getElementById('detailIdPelangganMsg').innerHTML = messageid;
                        inputPin.focus();
                    }else{
            ...
            var loadingCekID = document.getElementById("loading-cekid");
