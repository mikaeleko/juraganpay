                                ...
                                <div class="row">
                                  ...
                                  <div class="col-desk-12 struk" style="display:none;">
                                      <div class="row">
                                                ...
                                                <form method="POST" enctype="multipart/form-data" id="struk-upload-form" autocomplete="off">
                                                    ...
                                                    <tr>
                                                      <td rowspan="4">
                                                        <div style="text-align:center;position:relative">
                                                          <span id="batal-upload-photo-struk" class="upload-photo-struk-batal">Hapus Gambar</span>
                                                          <img style="width:170px;" id="img-struk" src="<?=$print_setting->image?>" alt=""><br>
                                                          <style>
                                                            .upload-photo-struk{
                                                              color:#51afff;
                                                              cursor:pointer
                                                      ...
                                                      <td>
                                                        <input value="<?=$print_setting->outlet_name?>" name="outlet_name" style="border-radius:8px;width:100%;" placeholder="Nama Outlet" type="text" class="form-input-text">
                                                      </td>
                                                    </tr>
                                                    <tr>
                                                      <td>
                                                          <input value="<?=$print_setting->address?>" name="address" style="border-radius:8px;width:100%;" placeholder="Alamat" type="text" class="form-input-text">
                                                      </td>
                                                    </tr>
                                                    <tr>
                                                      <td>
                                                          <input value="<?=$print_setting->npwp?>" name="npwp" style="border-radius:8px;width:100%;" placeholder="NPWP" type="text" class="form-input-text">
                                                      </td>
                                                    </tr>
                                                    <tr>
                                                      <td>
                                                          <input type="hidden" name="font_size" value="<?=$print_setting->font_size?>">
                                                          <input type="hidden" name="paper_size" value="<?=$print_setting->paper_size?>">
                                                          <input value="<?=$print_setting->phone_number?>" name="phone_number" style="border-radius:8px;width:100%;" placeholder="No Telepon" type="text" class="form-input-text">
                                                      </td>
                                                    </tr>
                                                  </table>
                                                  ...
                                                  <table class="full-width">
                                                    <tr>
                                                      ...
                                                      <td><input value="<?=$print_setting->web?>" name="web" style="border-radius:8px;width:100%" placeholder="http://" type="text" class="form-input-text"></td>
                                                    </tr>
                                                    <tr>
                                                      <td class=""><img src="<?=base_url()?>images/icon/icon_small_fb.png" title="facebook" style="width:20px;height:20px" alt=""></td>
                                                      <td class=""><input value="<?=$print_setting->facebook?>" name="facebook" style="border-radius:8px;width:100%" placeholder="http://" type="text" class="form-input-text"></td>
                                                    </tr>
                                                    <tr>
                                                      <td class=""><img src="<?=base_url()?>images/icon/icon_small_instagram.png" title="instagram" style="width:20px;height:20px" alt=""></td>
                                                      <td class=""><input value="<?=$print_setting->instagram?>" name="instagram" style="border-radius:8px;width:100%" placeholder="@" type="text" class="form-input-text"></td>
                                                    </tr>
                                                    <tr>
                                                      <td class=""><img src="<?=base_url()?>images/icon/icon_small_twitter.png" title="twitter" style="width:20px;height:20px" alt=""></td>
                                                      <td class=""><input value="<?=$print_setting->twitter?>" name="twitter" style="border-radius:8px;width:100%" placeholder="@" type="text" class="form-input-text"></td>
                                                    </tr>
                                                  </table>
                                                  ...
                                                  <textarea class="textarea1 full-width" name="notes"><?=$print_setting->notes?></textarea>
                                                  <input id="save-struk" class="right" type="submit">
                                                </form>
                                              </div>
                                          ...
                                          <div class="col-desk-6">
                                            <div id="loading-struk" class="loading-ring" style="display:none"><div></div><div></div><div></div><div></div></div>
                                            <div style="background-color:white; margin:10px;padding:10px;width:58mm">
                                              <div id='struk_err_msg' style='display: none; '>
                                                <div id='content_result'>
                                                  <div id='struk_err_show' class="w3-text-red">
                                                    <div id='struk_msg' style="border:1px; width:auto; height:auto; padding:2px; color:red; font-size:15px;text-align:left;display:table;"> </div>
                                              ...
                                              <div style="text-align:center;word-wrap: display:block">
                                                <img id="image-priview-print" src="<?=$print_setting->image?>" style="width:80px;"><br>
                                                <span style="font-size:12px;font-weight:400;font-family:monospace"><?=$print_setting->outlet_name?></span><br>
                                                <span style="font-size:12px;font-weight:400;font-family:monospace"><?=$print_setting->address?></span><br>
                                                <span style="font-size:12px;font-weight:400;font-family:monospace"><?=$print_setting->npwp?></span><br>
                                                <span style="font-size:12px;font-family:monospace"><?=$print_setting->phone_number?></span>
<pre style="white-space: pre-wrap;font-size:12px;word-wrap: break-word;width:58mm">PEMBAYARAN PLN
INVOICE NUMBER : 60540700
NAMA           : R SUMALI2
IDPEL          : 234234234
PERIODE        : 201202,201203,201204,201205
LEMBAR TAGIHAN : 4
TAGIHAN        : Rp     887.849
TOTAL ADMIN    : Rp      12.000
TOTAL          : Rp     899.849
CATATAN        : TIDAK DIIJINKAN MENAMBAH CHARGE
SUBSCRIBERSEGMENTATION: R1
POWERCONSUMINGCATEGORY: 000000900
SLALWBP1       : 00873500
SAHLWBP1       : 00876600
SAHLWBP2       : 00919900
SAHLWBP3       : 00973300
SAHLWBP4       : 01031500
STATUS   : BERHASIL</pre>
                                                  <table class="full-width" style="font-size:12px;font-weight:400;font-family:monospace;color:rgba(112,112,112,1)">
                                                    <tr>
                                                      <td><img src="<?=base_url()?>images/icon/icon_small_web.png" title="web" style="width:20px;height:20px" alt=""></td>
                                                      <td><?=$print_setting->web?></td>
                                                    </tr>
                                                    <tr>
                                                      <td><img src="<?=base_url()?>images/icon/icon_small_fb.png" title="facebook" style="width:20px;height:20px" alt=""></td>
                                                      <td><?=$print_setting->facebook?></td>
                                                    </tr>
                                                    <tr>
                                                      <td><img src="<?=base_url()?>images/icon/icon_small_instagram.png" title="instagram" style="width:20px;height:20px" alt=""></td>
                                                      <td><?=$print_setting->instagram?></td>
                                                    </tr>
                                                    <tr>
                                                      <td><img src="<?=base_url()?>images/icon/icon_small_twitter.png" title="twitter" style="width:20px;height:20px" alt=""></td>
                                                      <td><?=$print_setting->twitter?></td>
                                                    </tr>
                                                  </table>
                                                  <span style="font-size:12px;font-family:monospace"><?=$print_setting->notes?></span>
                                              </div>
                                            </div>
                                            <div id='struk_sukses_msg' style='display: none; padding: 10;'>
                                              <div id='content_result'>
                                                <div id='struk_sukses_show' class="w3-text-red">
                                                  <div id='struk_sukses' style="border:1px; width:auto; height:40px; padding:2px; color:green; font-size:15px;text-align:left;display:table;"> </div>
                                                  <div id="ikon" style="border:1px; width:auto; height:40px; padding:2px; color:green; font-size:15px;text-align:left;display:table;">
                                                    <img src="<?=$print_setting->image?>" style="width:40px; height:40px;">
                                                  </div>
        ...
        $(document).ready(function(){
          ...
          $.ajax({
              ...
              url:  "<?php echo base_url(); ?>" + "belanja/savesettingprint",
              data: data,
              processData: false,
              contentType: false,
              cache: false,
              ...
              success: function (data) {
                  ...
                  try{
                    ...
                    alert(data.pesan);
                    window.location = "<?=base_url()?>akun?action=settingstruk";
                  }catch{
                    alert("Terjadi kesalahan saat menyimpan setting print");
                  }
              },
              error: function (e) {
