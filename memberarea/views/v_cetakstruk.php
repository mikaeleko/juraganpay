...
<html>
    ...
    <body>
            ...
            <div id="modal" class="modal">
                <div class="modal-body">
                    ...
                    <div align="center">
                        ...
                        <br>
                        <button onclick="printDiv()" id="btn-kirim" class="button">
                                ...
                                <div class="row">
                                    <div class="col-desk-12">
                                        <div>
                                            ...
                                            <input type="text" class="form-input-text" id="input_sender" value="" placeholder="Pengirim">
        ...
        var textTmp,indexTmp,productTypeTmp,printtext;
        ...
        function printView(text, index, productType){
            ...
            var textPrintContent = (resultDataDitemukan[index].T_RAW_STRUK != null?(resultDataDitemukan[index].T_RAW_STRUK.STRUK):messageSplit)+'[CU]';
            printMessage += textPrintContent;
            printtext = textPrintContent;
            printMessage += "</pre></div>";
            printMessage += "</div>";
            textPrint.innerHTML = printMessage;
            modal.style.display = "block";
            if(textPrintContent.includes('TAGIHAN')){
                $('#button-ubah-harga').hide(100)
            }
