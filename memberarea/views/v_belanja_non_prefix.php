...
<html>
    <head>
        <title><?= TITLE." - ".strtoupper($this->input->get('category'))?></title>
                ...
                <div class="modal-body">
                    ...
                    <div style="padding-left:15%;padding-right:15%" align="center">
                        ...
                        <table style="width:100%">
                            <tr>
                                <td>No. Tujuan</td><td>:</td><td><div class="value-checkout">
                                <input placeholder="..." onkeydown="if (event.keyCode == 13) { return false;}" style="border-width:1;border-color: #d0d0d0;border-radius: 5px;margin-right: 0px;text-align:right;padding:5px;font-size:16px;font-family:Segoe UI;cursor:pointer" title="No Tujuan" id="checkout-nohp" type="text" ><div></td>
                            </tr>
                            <tr>
