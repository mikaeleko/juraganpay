...
<html>
    <head>
        ...
        <link rel="stylesheet" href="<?=HOST_MEMBER_AREA?>assets/css/style.css" type="text/css">
        <style media="screen">
        h3{
          color:#404040;
        }
        ...
        <div class="container smooth">
            <div class="header2">
                <div class="header-logo">
                    <img src="https://localhost/metroreload.biz/images/asset/default-logo-menu.png" style="width:50px; height:50px;vertical-align:middle;border-radius:50px;margin-top:15px;margin-left:10px">
                    <img style="vertical-align:middle;text-align:center;margin-top:15px" width="200px" height="50px" src="<?=HOST_MEMBER_AREA?>images/logoST24/whitest24.svg">
                </div>
                <div class="image-menu">
                    <img src="<?=HOST_MEMBER_AREA?>images/asset/menu.svg" alt="" onclick="showMenuDashboard()">
                </div>
            </div>
                ...
                <div class="parent-box-login">
                  ...
                  <div id="box-login" class="box-login2">
                      <form class="form-login">
                          ...
                          <div class="text-title" style="width:100%;text-align:center">Login Store Admin</div>
                          <div style="display: flex;justify-content: center;width:100%;"><img style="width:60px;height:60px;" src="<?=HOST_MEMBER_AREA?>images/logo_st24_nolabel.png"></div>
                          ...
                          <div id="box-captcha" style="display: flex;justify-content: center;width:100%;">
                            <img id="captcha" src="<?=site_url('login/securimage')?>" alt='captcha' />
                          </div>
                          <div style="display: flex;justify-content: center;width:100%;">
                            ...
                            <a href="javascript:void(0)" style="margin-top:12px;" onclick="refreshCaptcha()">
                              <img style="height:32px;width:32px;margin:0 auto;vertical-align: middle;" src="<?=HOST_MEMBER_AREA?>images/refreshblue2.png" alt="Refresh Captcha" onclick="this.blur()" style="border:0px;vertical-align:bottom;">
                            </a>
                          </div>
                          <div style="display: flex;justify-content: center;width:100%;">
                  ...
                  <div id="box-ubah" class="box-login2" style="display:none;">
                    <form>
                        <div style="display: flex;justify-content: center;width:100%;"><img src="<?=HOST_MEMBER_AREA?>images/logo_st24_nolabel.png"></div>
...
function refreshCaptcha(){
  ...
  $('#captcha').attr('src', "<?=site_url('login/securimage')?>");
  $("#capcode").val("");
}
    ...
    if(passold=='' && passnew=='' && passnew2=='')
      {
        ...
        $("#err_msg").show(100);
        $("#msg").html("Konfirmasi Password Baru Salah!");
        pason2.focus();
      } else {
