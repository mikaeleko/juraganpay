            ...
            <table class="display" id="banner"  style="text-align:left;font-size:14px;">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      <img onclick="get_banner_by_id(<?= $ban->banner_id ?>)" src="<?= base_url() ?>assets/icons/edits.jpg" alt="" style="cursor:pointer;width:20px ">
                      <img onclick="delete_banner(<?= $ban->banner_id ?>)" src="<?= base_url() ?>assets/icons/trash.png" alt=""  style="cursor:pointer;width:20px">
                    </td>
                  </tr>
                <?php } ?>
