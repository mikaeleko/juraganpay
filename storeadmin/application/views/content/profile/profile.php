            ...
            <table class="display" id="profile" width="100%" style="text-align:left;font-size:14px;">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      <img onclick="get_profile_by_keyname('<?= $pro->key_name ?>')" src="<?= base_url() ?>assets/icons/edits.jpg" alt="" style="cursor:pointer;width:20px ">
                      <!-- <img onclick="delete_profile('<?= $pro->key_name ?>')" src="<?= base_url() ?>assets/icons/trash.png" alt=""  style="cursor:pointer;width:20px"> -->
                    </td>
                  </tr>
                <?php } ?>
                </tbody>
