...
function get_product_by_id(id)   {
  save_method = 'update';
  api_img = 'http://localhost/metroreload.biz/serviceadmin/uploads/products/';
  $.ajax({
...
function get_category_by_id(id)   {
  ...
  $.ajax({
    ...
    dataType: "JSON",
    success: function(data)  {
        $('[name="product_category_id"]').val(data.product_category_id);
        $("#img").attr("src", api_img+data.icon);
        $('[name="product_category_name"]').val(data.product_category_name);
