...
class Category extends CI_Controller {
    ...
    $data['category'] = json_decode($this->curl->simple_get(API.'category?parent_id='.$this->input->get('parentid')));
    //die(json_encode($data['category']->data));
  ...
  public function ajax_get_category_by_id() {
    ...
    $id      = isset($get['id']) ? $get['id'] : '';
  	...
  	echo json_encode($data->data->category_list);
  }
