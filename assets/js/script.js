...
function menuActive(){
  ...
  if(urlTmp.includes('produk')){
    $('#menulist2').addClass('menuActive');
  }else if(urlTmp.includes('pendaftaran')){
    $('#menulist3').addClass('menuActive');
  }else if(urlTmp.includes('jabber')){
    $('#menulist5').addClass('menuActive');
  }else{
    $('#menulist1').addClass('menuActive');
  }
}
menuActive();
